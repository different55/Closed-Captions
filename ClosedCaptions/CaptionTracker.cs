...
public class CaptionTracker
{
    private const double AudibilityThreshold = 0.07;
    private Dictionary<string, CaptionedSound> _metadata;
    private ICoreClientAPI _api;
    private Queue<ILoadedSound> _activeSounds;
    public List<Caption> Captions = [];

    public CaptionTracker(ICoreClientAPI api)
    {
        _api = api;
    ...
    private CaptionedSound GetData(string id)
    {
    ...
    private void ProcessSound(SoundParams sound)
    {
    ...
    private void AddCaption(Caption newCaption)
    {
